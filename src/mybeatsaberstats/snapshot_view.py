...
class SnapshotCompareDialog(QDialog):
    ...
    def __init__(
        ...
        self._saved_metric_vsplitter_sizes: list[int] = [300, 300]  # _metric_vsplitter (SS/BL / AccSaber)
        ...
        self.table_acc.setHorizontalHeaderLabels(["Group", "Metric", "A", "B", "Diff(A⇒B)"])
