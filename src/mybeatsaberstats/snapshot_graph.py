...
class SnapshotGraphDialog(QDialog):
    ...
    def _build_metric_defs(self) -> List[_MetricDef]:
        ...
        metrics: List[_MetricDef] = [
            ...
            _MetricDef("accsaber_reloaded_overall_ap", "AccSaber Overall AP", is_int=False),
            _MetricDef("accsaber_reloaded_true_ap", "AccSaber True AP", is_int=False),
            _MetricDef("accsaber_reloaded_standard_ap", "AccSaber Standard AP", is_int=False),
            _MetricDef("accsaber_reloaded_tech_ap", "AccSaber Tech AP", is_int=False),
            _MetricDef("accsaber_reloaded_overall_rank", "AccSaber Overall Global Rank", is_int=True),
            _MetricDef("accsaber_reloaded_overall_rank_country", "AccSaber Overall Country Rank", is_int=True),
            _MetricDef("accsaber_reloaded_true_rank", "AccSaber True Global Rank", is_int=True),
            _MetricDef("accsaber_reloaded_true_rank_country", "AccSaber True Country Rank", is_int=True),
            _MetricDef("accsaber_reloaded_standard_rank", "AccSaber Standard Global Rank", is_int=True),
            _MetricDef("accsaber_reloaded_standard_rank_country", "AccSaber Standard Country Rank", is_int=True),
            _MetricDef("accsaber_reloaded_tech_rank", "AccSaber Tech Global Rank", is_int=True),
            _MetricDef("accsaber_reloaded_tech_rank_country", "AccSaber Tech Country Rank", is_int=True),
            _MetricDef("accsaber_reloaded_overall_ranked_plays", "AccSaber Overall Play Count", is_int=True),
            _MetricDef("accsaber_reloaded_true_ranked_plays", "AccSaber True Play Count", is_int=True),
